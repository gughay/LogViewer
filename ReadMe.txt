...
In order to avoid this boring process and have all errors in one place, I decided to create a web application for  logs (Log Viewer).
Also I plan to integrate signalr in this project to have real time log notifications from server to all clients.
So this is a n-tier application with asp.net core on server side and  angular on client side.